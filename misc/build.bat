...
pushd W:\build\
	if %DEBUG% equ 0 (
		...
		echo "Debug build"
		cl /nologo /DDATA_DIR="\"W:/data/\"" /DEXE_DIR="\"W:/build/\"" /DSRC_DIR="\"W:/src/\"" /std:c++17 /Od /DDEBUG=1 /Z7 /MTd /GR- /EHsc /EHa- %DEBUG_WARNINGS% %INCLUDES% /FeMeat.exe W:\src\Meat.cpp /link /DEBUG:FULL /opt:ref /incremental:no
	)
popd
